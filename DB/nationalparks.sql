...
INSERT INTO `national_park` (`id`, `name`, `description`, `location_id`, `link_nps`, `link_image_url`) VALUES (10, 'Capitol Reef', 'The park\'s Waterpocket Fold is a 100-mile (160 km) monocline that exhibits the earth\'s diverse geologic layers. Other natural features include monoliths, cliffs, and sandstone domes shaped like the United States Capitol.', 10, 'https://www.nps.gov/care/index.htm', 'WEB-INF/css/CapitalReef.jpg');
