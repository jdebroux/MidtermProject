...
INSERT INTO `national_park` (`id`, `name`, `description`, `location_id`, `link_nps`, `link_image_url`) VALUES (20, 'Gates of the Arctic', 'The country\'s northernmost park protects an expanse of pure wilderness in Alaska\'s Brooks Range and has no park facilities. The land is home to Alaska Natives who have relied on the land and caribou for 11,000 years.', 20, 'https://www.nps.gov/gaar/index.htm', 'GatesOfTheArctic.jpg');
INSERT INTO `national_park` (`id`, `name`, `description`, `location_id`, `link_nps`, `link_image_url`) VALUES (21, 'Glacier', 'The U.S. half of Waterton-Glacier International Peace Park, this park includes 26 glaciers and 130 named lakes surrounded by Rocky Mountain peaks. There are historic hotels and a landmark road called the Going-to-the-Sun Road in this region of rapidly receding glaciers. The local mountains, formed by an overthrust, expose Paleozoic fossils including trilobites, mollusks, giant ferns and dinosaurs.', 21, 'https://www.nps.gov/glac/index.htm', 'Glacier.jpg');
